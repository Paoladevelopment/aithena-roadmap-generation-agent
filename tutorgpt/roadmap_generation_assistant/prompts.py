...
roadmap_generation_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "Once the user confirms they want to proceed, immediately call the create_complete_roadmap tool to generate and save the complete roadmap. "
            "After the tool has finished, respond to the user with a brief confirmation message like: "
